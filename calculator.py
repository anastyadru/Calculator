...
class Calculator(QWidget):
    ...
    def initUI(self):
        ...
        self.ostatok.move(60, 375)

        self.ostatok_2 = QPushButton('//', self)
        self.ostatok_2.resize(50, 50)
        self.ostatok_2.move(115, 375)

        self.kvadrat = QPushButton('**', self)
        self.kvadrat.resize(50, 50)
        self.kvadrat.move(170, 375)
        ...
        self.ostatok.clicked.connect(self.ostatok)
        self.ostatok_2.clicked.connect(self.ostatok_2)
        self.kvadrat.clicked.connect(self.kvadrat)
